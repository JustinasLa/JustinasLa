...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    root = tree.getroot()
    find_and_replace(root, 'age_data', str(age_data))   # keep Uptime live
    justify_format(root, 'commit_data', commit_data, 22)
    # star_data / follower_data removed from SVGs (Plugin Users is filled in manually)
...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2006, 8, 14))  # birthdate -> Uptime field
